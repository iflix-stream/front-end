<template>
    <v-app style="background-size: 100% 100%;background-image: url(https://conta.nubank.com.br/images/sunrise.jpg)">

        <v-flex>

            <v-container>
                <v-layout row>
                    <v-flex  lg4 md3 hidden-sm-and-down></v-flex>

                    <v-flex xs12 lg4 md6 sm12 centered>
